...
def get_cosine_schedule_with_warmup(
    ...
    0.0 to lr over ``num_warmup_steps``, then decreases to the ``min_learning_rate`` on a 
    cosine schedule over the remaining ``num_training_steps-num_warmup_steps`` (assuming 
    ``num_cycles`` = 0.5).
    ...
    Args:
        ...
        min_learning_rate (float): The minimum learning rate to maintain after decay.
